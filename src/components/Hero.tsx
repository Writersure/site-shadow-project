  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 pt-32 pb-16 md:py-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="reveal">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-playfair font-bold text-primary leading-tight mb-6">
              Premium <span className="text-accent">AI-Powered</span> Content <br />& Digital Services
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://calendly.com/writersure369/30min" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="cta-btn flex gap-2">
                  Get Started
                  <ArrowRight size={18} />
                </Button>
              </a>
          ...
          <div className="reveal bg-white rounded-xl shadow-lg p-6 lg:p-8">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-playfair font-bold text-primary">Premium Ghostwriting</h2>
              <span className="bg-primary text-white px-4 py-1 rounded-full text-sm font-medium">Featured Service</span>
            </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex justify-center">
        <a 
          href="#services"
          className="animate-bounce bg-white p-2 w-10 h-10 ring-1 ring-primary/10 shadow-lg rounded-full flex items-center justify-center"
        >
