...
const Services = () => {
  return (
    <section id="services" className="py-16 md:py-24 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-purple-600 via-purple-100 to-blue-400">
      <div className="container mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-purple-900/30 hover-card rounded-xl shadow-md transition-all duration-300 overflow-hidden h-full"
            >
