        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <a href="https://web.whatsapp.com/send?phone=918297297307" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded-full hover:bg-purple-800 transition-colors">
                {/* WhatsApp Icon (SVG) */}
