        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-4">
            ...
            <div className="flex items-center space-x-4 mb-3">
              ...
              <span className="text-gray-300 text-sm">+91 9603917537</span>
            </div>
            <div className="flex items-center space-x-4">
              <MessageSquare size={18} className="text-purple-400" />
              <span className="text-gray-300 text-sm">+91 9603917537 (WhatsApp)</span>
            </div>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <a href="https://wa.me/919603917537" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded-full hover:bg-purple-800 transition-colors">
                {/* WhatsApp Icon (SVG) */}
