        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex space-x-3 mb-4">
              <a href="https://x.com/writersure" target="_blank" rel="noopener noreferrer" aria-label="Follow WriterSure on X (Twitter)" className="bg-background/10 p-2 rounded-full hover:bg-background/20 transition-colors">
              ...
              <a href="https://wa.me/919603917537" target="_blank" rel="noopener noreferrer" aria-label="Chat with WriterSure on WhatsApp" className="bg-background/10 p-2 rounded-full hover:bg-background/20 transition-colors">
