...
const caseStudiesData = [
  ...
  },
  {
    ...
    testimonial: "The WriterSure team took the time to truly understand our business and customers. The messaging they created perfectly captures our value proposition in a way that resonates with our target audience."
  },
  {
    id: "3",
    ...
    testimonial: "WriterSure's strategic approach to content has transformed our lead generation process. We're now attracting more qualified prospects and closing deals more efficiently than ever before."
  }
];
...
const CaseStudyDetail = () => {
  ...
  useEffect(() => {
    ...
    // Set page title
    document.title = study ? `${study.title} | WriterSure Case Study` : 'Case Study | WriterSure';
      ...
      <main className="flex-grow pt-28 pb-16 px-4 md:px-8 lg:px-12">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-8 reveal">
            <Link to="/case-studies" className="text-purple-600 font-medium hover:underline inline-flex items-center mb-4">
              <ArrowLeftIcon size={16} className="mr-2" /> Back to All Case Studies
            </Link>
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-black reveal">{caseStudy.title}</h1>
          ...
          <div className="prose max-w-none">
            ...
            <div className="mb-12 reveal bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow-md border-l-4 border-purple-600">
